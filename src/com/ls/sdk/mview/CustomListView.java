...
public class CustomListView extends ListView implements OnScrollListener {
	...
	private void init(Context pContext) {
		setCacheColorHint(pContext.getResources().getColor(R.color.trans));
	...
	private void  changeEndViewByState() {
		if (mCanLoadMore) {
			...
			case ENDINT_LOADING://刷新中
				...
				mEndLoadTipsTextView.setText("加载中&#8230");
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (mCanRefresh) {
			...
			case MotionEvent.ACTION_CANCEL:
				//解决ViewPager事件中左右滑动的时候丢失了ACTION_UP事件，导致下拉刷新没有正常关闭
				if (mHeadState != REFRESHING && mHeadState != LOADING) {
					if (mHeadState == DONE) {
...
//			mLastUpdatedTextView.setVisibility(View.VISIBLE);
		...
		case REFRESHING:
			...
			// 正在刷新...
			mTipsTextView.setText("正在刷新&#8230");
//			mLastUpdatedTextView.setVisibility(View.VISIBLE);
...
//			mLastUpdatedTextView.setVisibility(View.VISIBLE);
	...
	private void onLoadMore() {
		if (mLoadMoreListener != null) {
			// 加载中...
			mEndLoadTipsTextView.setText("最近更新&#160;&#058;&#160");
			mEndLoadTipsTextView.setVisibility(View.VISIBLE);
			mEndLoadProgressBar.setVisibility(View.VISIBLE);
