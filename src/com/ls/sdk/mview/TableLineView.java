...
public class TableLineView extends View {
	...
	public TableLineView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	/**
	 * 初始化数据支撑 View初始化时可以考虑给予一个模拟数据 当然我们可以通过setData方法设置自己的数据
	 */
	...
	/**
	 * 绘制曲线 这里我使用一个新的Bitmap对象结合新的Canvas对象来绘制曲线
	...
	public synchronized void setData(List<PointF> pointFs, String signX,
		...
		/*
		 * 控制数据长度不超过10个 对于折线图来说数据太多就没必要用折线图表示了而是使用散点图
		 */
		if (pointFs.size() > 10)
