...
/**
 *	Fragment 条目点击仿ios7弹出来的效果
 *	当你点击的时候弹出来一个fragment 的条目
 *	开启方法首先activity要继承FragmentActivity
 *	然后设置一个Fragment的样式setTheme(R.style.ActionSheetStyleIOS7);展现的效果
 *	最后利用Build工厂模式让这个Fragment开启
 *		IosItemClickFragment.createBuilder(this, getSupportFragmentManager())
 ...
 *	
 */
public class IosItemClickFragment extends Fragment implements OnClickListener {
	...
	private IosItemListener mListener;
	private View mView;
	...
	public void setActionSheetListener(IosItemListener listener) {
		mListener = listener;
	}
	...
	public static class Builder {
		...
		public Builder setListener(IosItemListener listener) {
		...
		public IosItemClickFragment show() {
						IosItemClickFragment actionSheet = (IosItemClickFragment) Fragment.instantiate(
					mContext, IosItemClickFragment.class.getName(), prepareArguments());
	...
	public static interface IosItemListener {

		void onDismiss(IosItemClickFragment actionSheet, boolean isCancel);

		void onOtherButtonClick(IosItemClickFragment actionSheet, int index);
	}
